...
if (process.env.NODE_ENV === 'development_ali') {
  CommonConfig.output.publicPath = 'http://e-im-dev.icsoc.net/';
} else if (process.env.NODE_ENV === 'test_ali') {
  CommonConfig.output.publicPath = 'http://e-im-test.icsoc.net/';
} else if (process.env.NODE_ENV === 'production') {
  CommonConfig.output.publicPath = 'http://e-im.icsoc.net/';
} else if (process.env.NODE_ENV === 'staging_ali') {
  CommonConfig.output.publicPath = 'http://e-im-staging.icsoc.net/';
} else {
  CommonConfig.output.publicPath = 'http://e-im-dev.icsoc.net/';
}
